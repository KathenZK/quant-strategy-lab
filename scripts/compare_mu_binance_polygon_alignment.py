...
SUMMARY_PATH = Path("reports/mu_binance_polygon_15m_alignment.json")
ALIGNED_PATH = Path("reports/mu_binance_polygon_15m_aligned.csv")
BUCKET_PATH = Path("reports/mu_binance_polygon_15m_alignment_by_session.csv")
