...
REPORT_PATH = Path("reports/hype_state_machine_v12_hard_exit.json")
RANKING_PATH = Path("reports/hype_state_machine_v12_hard_exit_ranking.csv")
SUMMARY_PATH = Path("reports/hype_state_machine_v12_hard_exit_diagnostics_summary.csv")
CATEGORY_PATH = Path("reports/hype_state_machine_v12_hard_exit_diagnostics_categories.csv")
DETAIL_PATH = Path("reports/hype_state_machine_v12_hard_exit_diagnostics_detail.csv")
