...
REPORT_PATH = Path("reports/hype_trade_path_diagnostics_v11.json")
DETAIL_PATH = Path("reports/hype_trade_path_diagnostics_v11_detail.csv")
SUMMARY_PATH = Path("reports/hype_trade_path_diagnostics_v11_summary.csv")
CATEGORY_PATH = Path("reports/hype_trade_path_diagnostics_v11_categories.csv")
