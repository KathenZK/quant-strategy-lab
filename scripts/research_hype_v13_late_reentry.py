...
REPORT_PATH = Path("reports/hype_v13_late_reentry.json")
RANKING_PATH = Path("reports/hype_v13_late_reentry_ranking.csv")
TRADES_PATH = Path("reports/hype_v13_late_reentry_trades.csv")
DIAG_SUMMARY_PATH = Path("reports/hype_v13_late_reentry_diagnostics_summary.csv")
DIAG_DETAIL_PATH = Path("reports/hype_v13_late_reentry_diagnostics_detail.csv")
