...
REPORT_PATH = Path("reports/hype_ema_oscillator_top_exit_v10.json")
RANKING_PATH = Path("reports/hype_ema_oscillator_top_exit_v10_ranking.csv")
TOP_TRADES_PATH = Path("reports/hype_ema_oscillator_top_exit_v10_top_trades.csv")
