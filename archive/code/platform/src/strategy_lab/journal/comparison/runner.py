...
from strategy_lab.journal.batches import WorkflowBatchRunner
from strategy_lab.journal.comparison.models import StrategyComparisonArtifacts, StrategyComparisonConfig, StrategyComparisonEntry
from strategy_lab.journal.registry import BacktestJournal, BacktestJournalEntry
from strategy_lab.workflow import load_strategy_workflow
from strategy_lab.journal.reporting.comparison import render_strategy_comparison_report
...
class StrategyComparisonRunner:
    ...
    def compare(self, config: StrategyComparisonConfig) -> StrategyComparisonArtifacts:
        ...
        BacktestJournal(runtime_runner.layout.reports_dir, db_path=runtime_runner.layout.run_registry_db_path).append(
