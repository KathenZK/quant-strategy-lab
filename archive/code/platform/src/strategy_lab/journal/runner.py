...
from strategy_lab.journal.models import ExperimentArtifacts, ExperimentConfig, ExperimentEntry, ExperimentVariant
...
class ExperimentRunner:
    ...
    def run(self, config: ExperimentConfig) -> ExperimentArtifacts:
        ...
        BacktestJournal(runner.layout.reports_dir, db_path=runner.layout.run_registry_db_path).append(
