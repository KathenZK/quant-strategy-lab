...
本组 legacy Canvas 已迁移到 `../../../../research/hype/families/ema-trend-breakout/legacy-canvas/`；核心台账已迁移到 `../../../../research/hype/families/ema-trend-breakout/hype-ema-tb-core-ledger.md`。
