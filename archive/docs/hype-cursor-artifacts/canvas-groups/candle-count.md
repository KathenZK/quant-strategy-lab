...
本组 legacy Canvas 已迁移到 `../../../../research/hype/families/candle-count-reversal/legacy-canvas/`；核心里程碑台账已迁移到 `../../../../research/hype/families/candle-count-reversal/hype-cc-15m-milestone-comparison.md`。
