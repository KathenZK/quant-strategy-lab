...
`/Users/ZK/.cursor/projects/Users-ZK-OpenCode-quant-strategy-lab/`

Known subdirectories:

- `canvases/`: Cursor Canvas `.canvas.tsx` files.
- `assets/`: images referenced by Cursor artifacts.
- `agent-transcripts/`: Cursor agent transcript JSONL files.
