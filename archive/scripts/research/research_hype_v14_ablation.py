...
REPORT_PATH = Path("reports/hype_v14_ablation.json")
RANKING_PATH = Path("reports/hype_v14_ablation_ranking.csv")
SENSITIVITY_PATH = Path("reports/hype_v14_ablation_sensitivity.csv")
WINDOWS_PATH = Path("reports/hype_v14_ablation_top_windows.csv")
DIAG_BASE_PATH = Path("reports/hype_v14_ablation_base_diagnostics_summary.csv")
DIAG_BEST_PATH = Path("reports/hype_v14_ablation_best_diagnostics_summary.csv")
DIAG_DETAIL_PATH = Path("reports/hype_v14_ablation_best_diagnostics_detail.csv")
