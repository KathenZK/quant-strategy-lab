...
REPORT_PATH = Path("reports/hype_v17_trend_state_search.json")
RANKING_PATH = Path("reports/hype_v17_trend_state_search_ranking.csv")
CONSTRAINT_PATH = Path("reports/hype_v17_trend_state_search_constraints.csv")
TRADES_PATH = Path("reports/hype_v17_trend_state_search_top_trades.csv")
