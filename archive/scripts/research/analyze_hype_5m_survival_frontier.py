...
MAIN_RANKING = Path("reports/hype_5m_positive_payoff_search_ranking.csv")
TARGETED_RANKING = Path("reports/hype_5m_positive_payoff_targeted_r05578.csv")
REPORT_PATH = Path("reports/hype_5m_survival_frontier.json")
FRONTIER_PATH = Path("reports/hype_5m_survival_frontier_summary.csv")
BEST_PATH = Path("reports/hype_5m_survival_frontier_best_rows.csv")
