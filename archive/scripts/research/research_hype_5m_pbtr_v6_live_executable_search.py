...
REPORT_PATH = Path("reports/hype_5m_pbtr_v6_live_executable_search.json")
PRESCREEN_PATH = Path("reports/hype_5m_pbtr_v6_live_executable_prescreen.csv")
CANDIDATE_PATH = Path("reports/hype_5m_pbtr_v6_live_executable_candidates.csv")
SLICE_PATH = Path("reports/hype_5m_pbtr_v6_live_executable_slices.csv")
MONTHLY_PATH = Path("reports/hype_5m_pbtr_v6_live_executable_monthly.csv")
MARKDOWN_PATH = Path(
