...
REPORT_PATH = Path("reports/hype_5m_positive_payoff_search.json")
RANKING_PATH = Path("reports/hype_5m_positive_payoff_search_ranking.csv")
TARGET_HITS_PATH = Path("reports/hype_5m_positive_payoff_search_target_hits.csv")
TRADES_PATH = Path("reports/hype_5m_positive_payoff_search_top_trades.csv")
