...
REPORT_PATH = Path("reports/hype_5m_pbtr_v2_live_cost_ablation_slices.json")
ABLATION_SUMMARY_PATH = Path("reports/hype_5m_pbtr_v2_live_cost_ablation_summary.csv")
ABLATION_SLICE_PATH = Path("reports/hype_5m_pbtr_v2_live_cost_ablation_validation_slices.csv")
WEEKLY_SLICE_PATH = Path("reports/hype_5m_pbtr_v2_live_cost_weekly_slices.csv")
ROLLING_WINDOW_PATH = Path("reports/hype_5m_pbtr_v2_live_cost_rolling_windows.csv")
MARKDOWN_PATH = Path(
