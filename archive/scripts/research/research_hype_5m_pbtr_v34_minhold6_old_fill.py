...
REPORT_PATH = Path("reports/hype_5m_pbtr_v34_minhold6_old_fill.json")
SUMMARY_PATH = Path("reports/hype_5m_pbtr_v34_minhold6_old_fill_summary.csv")
DIAGNOSTICS_PATH = Path("reports/hype_5m_pbtr_v34_minhold6_old_fill_trade_diagnostics.csv")
CROSSED_SUMMARY_PATH = Path("reports/hype_5m_pbtr_v34_minhold6_old_fill_crossed_summary.csv")
ROLLING_PATH = Path("reports/hype_5m_pbtr_v34_minhold6_old_fill_rolling.csv")
WEEKLY_PATH = Path("reports/hype_5m_pbtr_v34_minhold6_old_fill_weekly.csv")
MONTHLY_PATH = Path("reports/hype_5m_pbtr_v34_minhold6_old_fill_monthly.csv")
MARKDOWN_PATH = Path(
...
def render_markdown(summary: pd.DataFrame, crossed_summary: pd.DataFrame, rolling: pd.DataFrame) -> str:
    ...
    lines.extend(
        [
            ...
            "## 产物",
            "",
            f"- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v34_minhold6_old_fill.py`",
            f"- JSON：`{REPORT_PATH}`",
