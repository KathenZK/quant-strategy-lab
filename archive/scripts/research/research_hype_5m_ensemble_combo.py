...
REPORT_PATH = Path("reports/hype_5m_ensemble_combo.json")
RANKING_OUT = Path("reports/hype_5m_ensemble_combo_ranking.csv")
LEGS_OUT = Path("reports/hype_5m_ensemble_combo_legs.csv")
TRADES_OUT = Path("reports/hype_5m_ensemble_combo_selected_trades.csv")
