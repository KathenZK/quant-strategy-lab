...
REPORT_PATH = Path("reports/hype_ema_volume_overlay_v8_ablation.json")
DETAIL_PATH = Path("reports/hype_ema_volume_overlay_v8_ablation_detail.csv")
SUMMARY_PATH = Path("reports/hype_ema_volume_overlay_v8_ablation_summary.csv")
