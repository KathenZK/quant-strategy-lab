...
REPORT_PATH = Path("reports/hype_5m_pbtr_v21a_fixed_hold_exit.json")
SUMMARY_PATH = Path("reports/hype_5m_pbtr_v21a_fixed_hold_exit_summary.csv")
SLICE_PATH = Path("reports/hype_5m_pbtr_v21a_fixed_hold_exit_slices.csv")
MONTHLY_PATH = Path("reports/hype_5m_pbtr_v21a_fixed_hold_exit_monthly.csv")
RECENT_TRADES_PATH = Path("reports/hype_5m_pbtr_v21a_fixed_hold_exit_recent_trades.csv")
MARKDOWN_PATH = Path(
    ...
    *,
    ...
    rows.extend(
        [
            ...
            "## 产物",
            "",
            "- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v21a_fixed_hold_exit.py`",
            f"- JSON：`{REPORT_PATH}`",
