...
BASE_RANKING_PATH = Path("reports/hype_5m_indicator_search_ranking.csv")
REPORT_PATH = Path("reports/hype_5m_filter_refinement.json")
RANKING_PATH = Path("reports/hype_5m_filter_refinement_ranking.csv")
TARGET_HITS_PATH = Path("reports/hype_5m_filter_refinement_target_hits.csv")
REFINED_TRADES_PATH = Path("reports/hype_5m_filter_refinement_top_trades.csv")
