...
REPORT_PATH = Path("reports/hype_v15_effective_cross.json")
CROSS_PATH = Path("reports/hype_v15_effective_cross_events.csv")
RULE_PATH = Path("reports/hype_v15_effective_cross_rule_stats.csv")
RANKING_PATH = Path("reports/hype_v15_effective_cross_ranking.csv")
REGIME_PATH = Path("reports/hype_v15_effective_cross_regimes.csv")
