...
REPORT_PATH = Path("reports/hype_5m_pbtr_v52_walk_forward_ranking.json")
SUMMARY_PATH = Path("reports/hype_5m_pbtr_v52_walk_forward_ranking_summary.csv")
SEGMENTS_PATH = Path("reports/hype_5m_pbtr_v52_walk_forward_ranking_segments.csv")
AUDIT_PATH = Path("reports/hype_5m_pbtr_v52_paper_audit_events.csv")
MARKDOWN_PATH = Path(
...
def render_markdown(
    ...
    lines.extend(
        [
            ...
            "## Outputs",
            "",
            "- Script: `archive/scripts/research/research_hype_5m_pbtr_v52_walk_forward_ranking.py`",
            f"- JSON: `{REPORT_PATH}`",
