...
REPORT_PATH = Path("reports/hype_5m_pbtr_v33_no_stop_atr_old_fill.json")
SUMMARY_PATH = Path("reports/hype_5m_pbtr_v33_no_stop_atr_old_fill_summary.csv")
ROLLING_PATH = Path("reports/hype_5m_pbtr_v33_no_stop_atr_old_fill_rolling.csv")
WEEKLY_PATH = Path("reports/hype_5m_pbtr_v33_no_stop_atr_old_fill_weekly.csv")
MONTHLY_PATH = Path("reports/hype_5m_pbtr_v33_no_stop_atr_old_fill_monthly.csv")
DIAGNOSTICS_PATH = Path("reports/hype_5m_pbtr_v33_no_stop_atr_old_fill_trade_diagnostics.csv")
CROSSED_BREAKDOWN_PATH = Path("reports/hype_5m_pbtr_v33_no_stop_atr_old_fill_crossed_breakdown.csv")
MARKDOWN_PATH = Path(
...
def render_markdown(
    ...
    lines.extend(
        [
            ...
            "## 产物",
            "",
            f"- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v33_no_stop_atr_old_fill.py`",
            f"- JSON：`{REPORT_PATH}`",
