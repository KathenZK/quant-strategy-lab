...
REPORT_PATH = Path("reports/hype_5m_pbtr_v32_clean_entry_filters.json")
SUMMARY_PATH = Path("reports/hype_5m_pbtr_v32_clean_entry_filters_summary.csv")
ROLLING_PATH = Path("reports/hype_5m_pbtr_v32_clean_entry_filters_rolling.csv")
WEEKLY_PATH = Path("reports/hype_5m_pbtr_v32_clean_entry_filters_weekly.csv")
MONTHLY_PATH = Path("reports/hype_5m_pbtr_v32_clean_entry_filters_monthly.csv")
TRADES_PATH = Path("reports/hype_5m_pbtr_v32_clean_entry_filters_trades.csv")
MARKDOWN_PATH = Path(
...
def render_markdown(summary: pd.DataFrame, rolling: pd.DataFrame, weekly: pd.DataFrame, monthly: pd.DataFrame) -> str:
    ...
    lines.extend(
        [
            ...
            "## 产物",
            "",
            f"- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v32_clean_entry_filters.py`",
            f"- JSON：`{REPORT_PATH}`",
