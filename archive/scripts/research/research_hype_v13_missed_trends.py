...
REPORT_PATH = Path("reports/hype_v13_missed_trends.json")
CANDIDATE_PATH = Path("reports/hype_v13_missed_trends_candidates.csv")
REGIME_PATH = Path("reports/hype_v13_missed_trends_regimes.csv")
SKIPPED_TRADE_PATH = Path("reports/hype_v13_missed_trends_skipped_v12_3_trades.csv")
REJECTED_EPISODE_PATH = Path("reports/hype_v13_missed_trends_rejected_signal_episodes.csv")
