...
REPORT_PATH = Path("reports/hype_v14_slow_trend_entry.json")
RANKING_PATH = Path("reports/hype_v14_slow_trend_entry_ranking.csv")
REGIME_PATH = Path("reports/hype_v14_slow_trend_entry_regimes.csv")
TRADE_PATH = Path("reports/hype_v14_slow_trend_entry_best_trades.csv")
