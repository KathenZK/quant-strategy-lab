...
REPORT_PATH = Path("reports/hype_5m_r05732_v2_combo_test.json")
RANKING_PATH = Path("reports/hype_5m_r05732_v2_combo_test_ranking.csv")
SLICE_PATH = Path("reports/hype_5m_r05732_v2_combo_test_slices.csv")
