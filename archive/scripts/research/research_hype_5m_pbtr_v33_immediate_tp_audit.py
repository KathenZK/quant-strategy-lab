...
REPORT_PATH = Path("reports/hype_5m_pbtr_v33_immediate_tp_audit.json")
SUMMARY_PATH = Path("reports/hype_5m_pbtr_v33_immediate_tp_audit_summary.csv")
MARKDOWN_PATH = Path(
...
def render_markdown(summary: pd.DataFrame, cfg: Any) -> str:
    ...
    lines = [
        ...
        "## 产物",
        "",
        "- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v33_immediate_tp_audit.py`",
        f"- JSON：`{REPORT_PATH}`",
