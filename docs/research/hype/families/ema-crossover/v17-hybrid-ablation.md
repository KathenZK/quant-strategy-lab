...
`archive/scripts/research/research_hype_v17_hybrid_ablation.py`
...
Reports are ignored local artifacts under `reports/`:

- `reports/hype_v17_hybrid_ablation.json`
- `reports/hype_v17_hybrid_ablation_ranking.csv`
- `reports/hype_v17_hybrid_ablation_sensitivity.csv`
- `reports/hype_v17_hybrid_ablation_top_windows.csv`
- `reports/hype_v17_hybrid_ablation_trade_attribution.csv`
- `reports/hype_v17_hybrid_ablation_base_diagnostics_summary.csv`
- `reports/hype_v17_hybrid_ablation_best_diagnostics_summary.csv`
- `reports/hype_v17_hybrid_ablation_best_diagnostics_detail.csv`
