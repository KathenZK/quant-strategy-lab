...
- `archive/scripts/research/research_hype_v16_indicator_expansion.py`
- `archive/scripts/research/research_hype_v17_trend_state_search.py`

## Report Artifacts

Reports are local ignored artifacts under `reports/`.
...
The main ledger is `hype-ema-x-core-ledger.md`. Full rules and parameters are mirrored in `v15-v16-promoted-strategy-specs.md` and `v17-hybrid-ablation.md`.
