...
交易路径图：`diagnostics/hype-5m-pbtr-v31-min-hold-9-trade-path-2026-06-24.html`。
...
12. V2/V2.1/V3/V3.1/V3.2/V3.3/V4 系列都不应直接大资金上线；当前优先重做 `min_hold_bars + trailing` 退出路径。
