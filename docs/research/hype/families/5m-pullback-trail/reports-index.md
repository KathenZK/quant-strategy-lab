# HYPE-5M-PBTR Reports Index

Reports are local artifacts under `reports/` and are ignored by git.

Use this file as the durable pointer layer for HYPE Binance `5m` research.
...
- Positive-payoff search: `hype-5m-positive-payoff-search-2026-06-23.md`
- Forward OOS for initial ensemble batch: `hype-5m-ensemble-forward-oos-2026-06-23.md`
- Original indicator ensemble search: `hype-5m-indicator-ensemble-search.md`
- Historical ensemble live specs: `ensemble-specs/README.md`
