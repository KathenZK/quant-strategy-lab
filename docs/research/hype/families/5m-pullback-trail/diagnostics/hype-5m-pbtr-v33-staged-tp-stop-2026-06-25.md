...
- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v33_staged_tp_stop.py`
- JSON：`reports/hype_5m_pbtr_v33_staged_tp_stop.json`
- 汇总 CSV：`reports/hype_5m_pbtr_v33_staged_tp_stop_summary.csv`
- 交易明细 CSV：`reports/hype_5m_pbtr_v33_staged_tp_stop_trades.csv`
- rolling CSV：`reports/hype_5m_pbtr_v33_staged_tp_stop_rolling.csv`
- weekly CSV：`reports/hype_5m_pbtr_v33_staged_tp_stop_weekly.csv`
- monthly CSV：`reports/hype_5m_pbtr_v33_staged_tp_stop_monthly.csv`
