...
- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v33_crossed_open_reanchor.py`
- JSON：`reports/hype_5m_pbtr_v33_crossed_open_reanchor.json`
- 汇总 CSV：`reports/hype_5m_pbtr_v33_crossed_open_reanchor_summary.csv`
- 交易诊断 CSV：`reports/hype_5m_pbtr_v33_crossed_open_reanchor_trade_diagnostics.csv`
