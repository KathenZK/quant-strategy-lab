...
- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v32_clean_entry_filters.py`
- JSON：`reports/hype_5m_pbtr_v32_clean_entry_filters.json`
- 汇总 CSV：`reports/hype_5m_pbtr_v32_clean_entry_filters_summary.csv`
- 滚动切片：`reports/hype_5m_pbtr_v32_clean_entry_filters_rolling.csv`
- 周切片：`reports/hype_5m_pbtr_v32_clean_entry_filters_weekly.csv`
- 月切片：`reports/hype_5m_pbtr_v32_clean_entry_filters_monthly.csv`
- 交易明细：`reports/hype_5m_pbtr_v32_clean_entry_filters_trades.csv`
