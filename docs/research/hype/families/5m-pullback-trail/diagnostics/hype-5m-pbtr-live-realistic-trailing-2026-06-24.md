...
- JSON：`reports/hype_5m_pbtr_live_realistic_trailing.json`
- 汇总 CSV：`reports/hype_5m_pbtr_live_realistic_trailing_summary.csv`
- 交易诊断 CSV：`reports/hype_5m_pbtr_live_realistic_trailing_trade_diagnostics.csv`
- rolling CSV：`reports/hype_5m_pbtr_live_realistic_trailing_rolling.csv`
- weekly CSV：`reports/hype_5m_pbtr_live_realistic_trailing_weekly.csv`
- monthly CSV：`reports/hype_5m_pbtr_live_realistic_trailing_monthly.csv`
