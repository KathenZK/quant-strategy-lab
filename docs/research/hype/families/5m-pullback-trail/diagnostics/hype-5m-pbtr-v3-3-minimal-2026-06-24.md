...
- 脚本：`archive/scripts/research/research_hype_5m_pbtr_v3-3_minimal.py`
- JSON：`reports/hype_5m_pbtr_v3-3_minimal.json`
- 汇总 CSV：`reports/hype_5m_pbtr_v3-3_minimal_summary.csv`
- 滚动切片：`reports/hype_5m_pbtr_v3-3_minimal_rolling.csv`
- 周切片：`reports/hype_5m_pbtr_v3-3_minimal_weekly.csv`
- 月切片：`reports/hype_5m_pbtr_v3-3_minimal_monthly.csv`
- 交易明细：`reports/hype_5m_pbtr_v3-3_minimal_trades.csv`
