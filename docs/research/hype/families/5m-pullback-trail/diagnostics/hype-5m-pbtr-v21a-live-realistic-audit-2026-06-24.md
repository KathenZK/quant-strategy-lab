...
- JSON：`reports/hype_5m_pbtr_v21a_live_realistic_audit.json`
- 汇总 CSV：`reports/hype_5m_pbtr_v21a_live_realistic_audit_summary.csv`
- 交易诊断 CSV：`reports/hype_5m_pbtr_v21a_live_realistic_audit_trade_diagnostics.csv`
- rolling CSV：`reports/hype_5m_pbtr_v21a_live_realistic_audit_rolling.csv`
- weekly CSV：`reports/hype_5m_pbtr_v21a_live_realistic_audit_weekly.csv`
