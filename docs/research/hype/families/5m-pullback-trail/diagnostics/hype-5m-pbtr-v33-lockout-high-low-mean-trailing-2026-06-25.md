...
- JSON：`reports/hype_5m_pbtr_v33_lockout_high_low_mean_trailing.json`
- 汇总 CSV：`reports/hype_5m_pbtr_v33_lockout_high_low_mean_trailing_summary.csv`
- 交易诊断 CSV：`reports/hype_5m_pbtr_v33_lockout_high_low_mean_trailing_trade_diagnostics.csv`
