# HYPE-EMA-TB-5M-ENS-S01: 8 子腿 / 4x 实盘代码规格
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 全样本 | 2025-06-01 到 2026-06-01 | 570 | 121.31x | 120.91x | -19.22% | 85.79% | 0.87% | -11.33% |
| IS | 2025-06-01 到 2026-03-01 | 456 | 258.92x | 63.63x | -19.22% | 85.09% | 0.94% | -9.72% |
| OOS | 2026-03-01 到 2026-06-01 | 114 | 12.79x | 1.90x | -18.35% | 88.60% | 0.59% | -11.33% |

## 子腿列表

本策略使用 `reports/hype_5m_ensemble_combo_legs.csv` 的前 `8` 条子腿。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 3x | 是 | 570 | 37.65x | -14.49% | 85.79% | -83.66 | +4.72% | +0.00% |
| 4x | 是 | 570 | 121.31x | -19.22% | 85.79% | +0.00 | +0.00% | +0.00% |
| 5x | 否 | 570 | 383.04x | -24.02% | 85.79% | +261.73 | -4.80% | +0.00% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 单仓执行 | 是 | 570 | 121.31x | -19.22% | 85.79% | +0.00 | +0.00% | +0.00% |
| 取消单仓门槛 | 否 | 625 | 245.61x | -26.82% | 86.72% | +124.30 | -7.60% | +0.93% |

### 删除单条子腿消融

| 删除腿 | 删除对象 | 删除后达标 | 交易数 | 年化倍数 | 最大回撤 | 胜率 | 年化变化 | 回撤变化 | 胜率变化 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `HYPE_5M_C0410` | 否 | 503 | 100.90x | -22.51% | 86.68% | -20.41 | -3.29% | +0.89% |
| 2 | `HYPE_5M_C0355` | 否 | 506 | 90.23x | -21.32% | 85.97% | -31.08 | -2.11% | +0.18% |
| 3 | `HYPE_5M_C0332` | 是 | 533 | 72.67x | -19.00% | 85.74% | -48.63 | +0.22% | -0.05% |
| 4 | `HYPE_5M_C0337` | 否 | 545 | 88.33x | -22.26% | 86.06% | -32.98 | -3.04% | +0.27% |
| 5 | `HYPE_5M_C0230` | 否 | 465 | 51.80x | -20.61% | 86.24% | -69.51 | -1.39% | +0.45% |
| 6 | `HYPE_5M_C0412` | 是 | 547 | 97.48x | -19.22% | 86.65% | -23.83 | +0.00% | +0.87% |
| 7 | `HYPE_5M_C0350` | 否 | 523 | 106.25x | -20.80% | 86.04% | -15.06 | -1.58% | +0.25% |
| 8 | `HYPE_5M_C0409` | 是 | 533 | 116.95x | -19.22% | 86.68% | -4.36 | +0.00% | +0.89% |
