...
## 2026-08-06 — 接受 Polygon 15m regular-session canonical

Polygon MU 15m 在 XNAS regular-session、闭合、raw/normalized 对齐与 round-trip 全部通过后进入 canonical normalized；Yahoo 继续 `raw_unaccepted`，不填 `trade_count = 0` 且不放宽 schema。本决定只接受数据，不触发策略登记或 promotion；证据见 [`mu-polygon-15m-acceptance-2026-08-06.md`](diagnostics/mu-polygon-15m-acceptance-2026-08-06.md) 与 [`mu-polygon-15m-acceptance-2026-08-06.json`](artifacts/mu-polygon-15m-acceptance-2026-08-06.json)。
