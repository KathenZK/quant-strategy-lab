...
| `Binance-4H-EMA-Cross-LightGBM-Event-Selector`（`BIN-4H-EMAX-LGBM`） | [asset-portfolios/4h-ema-cross-lightgbm-event-selector/](asset-portfolios/4h-ema-cross-lightgbm-event-selector/README.md)（README 兼任临时主账） | archived / not promoted / not live-ready |
