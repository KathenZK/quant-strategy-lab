...
| `HYPE-1M-EMA-Crossover` | `HYPE-1M-EMA-X` | [hype/1m-ema-crossover/](hype/1m-ema-crossover/README.md) · [主账](hype/1m-ema-crossover/hype-1m-ema-x-core-ledger.md) | `1m` EMA 金叉/死叉，可执行时序 | explore / not promoted / not live-ready |
| `HYPE-1M-MA-Pullback-Scalp` | - | [hype/1m-ma-pullback-scalp/](hype/1m-ma-pullback-scalp/README.md) · [主账](hype/1m-ma-pullback-scalp/hype-1m-ma-pbs-core-ledger.md) | `1m` 双 MA 回踩 scalp | explore / not promoted / not live-ready |
...
| `HYPE-15M-Riptide` | - | [hype/15m-riptide/](hype/15m-riptide/README.md) · [主账](hype/15m-riptide/hype-15m-riptide-core-ledger.md) | `15m` EMA 趋势背景 RSI 回踩 + RV regime | explore / not promoted（复现对账未完成） |
...
| `HYPE-15M-Pullback-Trail` | - | [hype/15m-pullback-trail/](hype/15m-pullback-trail/README.md) · [主账](hype/15m-pullback-trail/hype-15m-pbtr-core-ledger.md) | `15m` 回踩事件源 + bracket 搜索 | explore / not promoted / not live-ready |
...
| `HYPE-5M-MA-Pullback-Scalp` | - | [hype/5m-ma-pullback-scalp/](hype/5m-ma-pullback-scalp/README.md) · [主账](hype/5m-ma-pullback-scalp/hype-5m-ma-pbs-core-ledger.md) | `5m` 双 MA 回踩 scalp | explore / not promoted / not live-ready |
...
| `Binance-15M-EMA-Cross-LightGBM-Event-Selector`（`BIN-15M-EMAX-LGBM`） | [家族](asset-portfolios/15m-ema-cross-lightgbm-event-selector/README.md) · [主账](asset-portfolios/15m-ema-cross-lightgbm-event-selector/binance-15m-emax-lgbm-core-ledger.md) | archived / HARD-GATE-FAILED（2026H1 锁定 OOS） |
| `Binance-1H-EMA-Cross-LightGBM-Event-Selector`（`BIN-1H-EMAX-LGBM`） | [家族](asset-portfolios/1h-ema-cross-lightgbm-event-selector/README.md) · [主账](asset-portfolios/1h-ema-cross-lightgbm-event-selector/binance-1h-emax-lgbm-core-ledger.md) | archived |
| `Binance-4H-EMA-Cross-LightGBM-Event-Selector`（`BIN-4H-EMAX-LGBM`） | [家族](asset-portfolios/4h-ema-cross-lightgbm-event-selector/README.md) · [主账](asset-portfolios/4h-ema-cross-lightgbm-event-selector/binance-4h-emax-lgbm-core-ledger.md) | explore / not promoted / not live-ready（V3 G2 未过） |
| `Binance-1D-EMA-Cross-LightGBM-Event-Selector`（`BIN-1D-EMAX-LGBM`） | [家族](asset-portfolios/1d-ema-cross-lightgbm-event-selector/README.md) · [主账](asset-portfolios/1d-ema-cross-lightgbm-event-selector/binance-1d-emax-lgbm-core-ledger.md) | archived |
| `Binance-1D-Multi-Asset-TSMOM-Vol-Target`（`BIN-1D-TSMOM-VT`） | [家族](asset-portfolios/1d-multi-asset-tsmom-vol-target/README.md) · [主账](asset-portfolios/1d-multi-asset-tsmom-vol-target/binance-1d-tsmom-vt-core-ledger.md) | explore / not promoted / not live-ready |
| `Multi-Asset-1D-EWMAC-Universal-Trend`（`XA-1D-EWMAC-UT`） | [家族](asset-portfolios/1d-ewmac-universal-trend/README.md) · [主账](asset-portfolios/1d-ewmac-universal-trend/binance-1d-ewmac-ut-core-ledger.md) | explore / not promoted / not live-ready |
| `Binance-15M-Multi-Asset-Trend-State-Machine`（`BIN-15M-TSM`） | [家族](asset-portfolios/15m-multi-asset-trend-state-machine/README.md) · [主账](asset-portfolios/15m-multi-asset-trend-state-machine/binance-15m-tsm-core-ledger.md) | archived / HARD-GATE-FAILED |
| `Binance-1D-Turtle-Breakout` | [家族](asset-portfolios/1d-turtle-breakout/README.md) · [主账](asset-portfolios/1d-turtle-breakout/binance-1d-turtle-core-ledger.md) | explore / not promoted / not live-ready |
...
| `Binance-15M-Multi-Indicator-Intraday-Transfer` | [家族](asset-portfolios/15m-multi-indicator-intraday/README.md) · [主账](asset-portfolios/15m-multi-indicator-intraday/binance-15m-mii-xfer-core-ledger.md) | explore / not promoted |
...
| `HYPE-Cross-Strategy-Account` | [诊断主题](asset-portfolios/hype-cross-strategy-account/README.md) | `diagnostic_topic / explore`；不创建策略主账，不提升子策略状态 |
