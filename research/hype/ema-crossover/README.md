...
- `research/hype/ema-crossover/scripts/research_hype_ema_cross_strategy.py`: base EMA cross research.
- `research/hype/ema-crossover/scripts/compare_hype_ema_v2_v4.py`: early EMA version comparison.
- `research/hype/ema-crossover/scripts/research_hype_ema_regime_hold_v5.py`: V5 regime-hold line.
- `research/hype/ema-crossover/scripts/research_hype_ema_volume_exhaustion_v7.py`: V7 volume exhaustion.
- `research/hype/ema-crossover/scripts/research_hype_ema_volume_overlay_v8.py`: V8 volume overlay.
- `research/hype/ema-crossover/scripts/research_hype_ema_htf_rsi_exit_v9.py`: V9 higher-timeframe RSI exit.
- `research/hype/ema-crossover/scripts/research_hype_ema_oscillator_top_exit_v10.py`: V10 oscillator top exit.
- `research/hype/ema-crossover/scripts/research_hype_trade_path_diagnostics_v11.py`: V11 trade-path diagnostics.
- `research/hype/ema-crossover/scripts/research_hype_state_machine_v12.py`: V12 state-machine line.
- `research/hype/ema-crossover/scripts/research_hype_v13_late_reentry.py`: V13 late re-entry line.
- `research/hype/ema-crossover/scripts/research_hype_v14_main_backfill.py`: V14 main backfill.
- `research/hype/ema-crossover/scripts/research_hype_v14_ablation.py`: V14 ablation.
- `research/hype/ema-crossover/scripts/research_hype_v14_atr_dynamic_entry.py`: V14 ATR dynamic entry.
- `research/hype/ema-crossover/scripts/research_hype_v14_slow_trend_entry.py`: V14 slow trend entry probe.
- `research/hype/ema-crossover/scripts/research_hype_v15_effective_cross.py`: post-V14 effective-cross quality probe.
- `research/hype/ema-crossover/scripts/research_hype_v16_indicator_expansion.py`: post-V14 RSI/KDJ-style late supplemental entry probe.
- `research/hype/ema-crossover/scripts/research_hype_v17_trend_state_search.py`: broad trend-state search across momentum, volatility, volume, structure, and oscillator indicators.
- `research/hype/ema-crossover/scripts/research_hype_v17_hybrid_ablation.py`: V17 V15/V16 hybrid full parameter ablation.
- `research/hype/ema-crossover/v16-v17-trend-state-search.md`: V16/V17 result note and next research direction.
- `research/hype/ema-crossover/v17-hybrid-ablation.md`: formal V17 hybrid definition, window metrics, and parameter ablation conclusions.
- `research/hype/ema-crossover/diagnostics/hype-ema-x-1m-binance-live-search-2026-06-25.md`: Binance HYPEUSDT `1m` live-executable EMA cross search; diagnostic / paper-live candidate only, not a live-approved promotion.
- `research/hype/ema-crossover/hype-ema-x-core-ledger.md`: main Markdown ledger for promoted HYPE-EMA-X versions.
- `research/hype/ema-crossover/v15-v16-promoted-strategy-specs.md`: full Chinese rule/parameter spec for promoted V15 and V16.
...
`hype_v17_hybrid_ablation*` report files are generated by `research/hype/ema-crossover/scripts/research_hype_v17_hybrid_ablation.py` and cover the official V17 baseline plus 143 single-parameter/single-module ablation candidates.
