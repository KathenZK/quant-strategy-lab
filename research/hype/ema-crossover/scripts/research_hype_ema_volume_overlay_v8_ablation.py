...
REPORT_PATH = Path("research/hype/ema-crossover/artifacts/hype_ema_volume_overlay_v8_ablation.json")
DETAIL_PATH = Path("research/hype/ema-crossover/artifacts/hype_ema_volume_overlay_v8_ablation_detail.csv")
SUMMARY_PATH = Path("research/hype/ema-crossover/artifacts/hype_ema_volume_overlay_v8_ablation_summary.csv")
