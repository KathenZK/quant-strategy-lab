...
REPORT_PATH = Path("research/hype/5m-pullback-trail/artifacts/hype_5m_pbtr_v32_full_ablation.json")
SUMMARY_PATH = Path("research/hype/5m-pullback-trail/artifacts/hype_5m_pbtr_v32_full_ablation_summary.csv")
SLICES_PATH = Path("research/hype/5m-pullback-trail/artifacts/hype_5m_pbtr_v32_full_ablation_validation_slices.csv")
ROLLING_PATH = Path("research/hype/5m-pullback-trail/artifacts/hype_5m_pbtr_v32_full_ablation_rolling.csv")
WEEKLY_PATH = Path("research/hype/5m-pullback-trail/artifacts/hype_5m_pbtr_v32_full_ablation_weekly.csv")
MONTHLY_PATH = Path("research/hype/5m-pullback-trail/artifacts/hype_5m_pbtr_v32_full_ablation_monthly.csv")
MARKDOWN_PATH = Path(
...
def render_markdown(summary: pd.DataFrame, rolling: pd.DataFrame, weekly: pd.DataFrame, monthly: pd.DataFrame) -> str:
    ...
    lines.extend([
        ...
        "## 产物",
        "",
        f"- 脚本：`research/hype/5m-pullback-trail/scripts/research_hype_5m_pbtr_v32_full_ablation.py`",
        f"- JSON：`{REPORT_PATH}`",
