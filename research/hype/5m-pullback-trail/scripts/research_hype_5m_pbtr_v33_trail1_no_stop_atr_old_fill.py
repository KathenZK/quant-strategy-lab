...
REPORT_PATH = Path("research/hype/families/5m-pullback-trail/artifacts/hype_5m_pbtr_v33_trail1_no_stop_atr_old_fill.json")
SUMMARY_PATH = Path("research/hype/families/5m-pullback-trail/artifacts/hype_5m_pbtr_v33_trail1_no_stop_atr_old_fill_summary.csv")
DIAGNOSTICS_PATH = Path("research/hype/families/5m-pullback-trail/artifacts/hype_5m_pbtr_v33_trail1_no_stop_atr_old_fill_trade_diagnostics.csv")
CROSSED_SUMMARY_PATH = Path("research/hype/families/5m-pullback-trail/artifacts/hype_5m_pbtr_v33_trail1_no_stop_atr_old_fill_crossed_summary.csv")
ROLLING_PATH = Path("research/hype/families/5m-pullback-trail/artifacts/hype_5m_pbtr_v33_trail1_no_stop_atr_old_fill_rolling.csv")
WEEKLY_PATH = Path("research/hype/families/5m-pullback-trail/artifacts/hype_5m_pbtr_v33_trail1_no_stop_atr_old_fill_weekly.csv")
MONTHLY_PATH = Path("research/hype/families/5m-pullback-trail/artifacts/hype_5m_pbtr_v33_trail1_no_stop_atr_old_fill_monthly.csv")
MARKDOWN_PATH = Path(
...
def render_markdown(summary: pd.DataFrame, crossed_summary: pd.DataFrame, rolling: pd.DataFrame) -> str:
    ...
    lines.extend(
        [
            ...
            "## 产物",
            "",
            f"- 脚本：`research/hype/families/5m-pullback-trail/scripts/research_hype_5m_pbtr_v33_trail1_no_stop_atr_old_fill.py`",
            f"- JSON：`{REPORT_PATH}`",
