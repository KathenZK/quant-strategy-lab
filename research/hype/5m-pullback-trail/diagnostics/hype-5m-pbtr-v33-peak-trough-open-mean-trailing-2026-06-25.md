...
- JSON：`artifacts/hype_5m_pbtr_v33_peak_trough_open_mean_trailing.json`
- 汇总 CSV：`artifacts/hype_5m_pbtr_v33_peak_trough_open_mean_trailing_summary.csv`
- 交易诊断 CSV：`artifacts/hype_5m_pbtr_v33_peak_trough_open_mean_trailing_trade_diagnostics.csv`
