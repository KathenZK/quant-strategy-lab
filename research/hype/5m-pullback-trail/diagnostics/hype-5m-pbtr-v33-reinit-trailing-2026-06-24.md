...
- JSON：`artifacts/hype_5m_pbtr_v33_reinit_trailing.json`
- 汇总 CSV：`artifacts/hype_5m_pbtr_v33_reinit_trailing_summary.csv`
- 交易诊断 CSV：`artifacts/hype_5m_pbtr_v33_reinit_trailing_trade_diagnostics.csv`
- rolling CSV：`artifacts/hype_5m_pbtr_v33_reinit_trailing_rolling.csv`
- weekly CSV：`artifacts/hype_5m_pbtr_v33_reinit_trailing_weekly.csv`
- monthly CSV：`artifacts/hype_5m_pbtr_v33_reinit_trailing_monthly.csv`
