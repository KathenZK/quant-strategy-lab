...
- 脚本：`research/hype/families/5m-pullback-trail/scripts/research_hype_5m_pbtr_v33_blend_peak_open_trailing.py`
- JSON：`artifacts/hype_5m_pbtr_v33_blend_peak_open_trailing.json`
- 汇总 CSV：`artifacts/hype_5m_pbtr_v33_blend_peak_open_trailing_summary.csv`
- 交易诊断 CSV：`artifacts/hype_5m_pbtr_v33_blend_peak_open_trailing_trade_diagnostics.csv`
