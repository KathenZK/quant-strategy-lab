...
- `ablations/hype-5m-pbtr-v6-2-1-full-parameter-ablation-2026-06-29.md`: full parameter ablation for `HYPE-5M-PBTR-V6.2.1`; keeps `htf_spread>=0` as the default dry-run expression and rejects higher-return non-pass variants with insufficient short-side OOS evidence.
- `diagnostics/hype-5m-pbtr-v6-2-1-live-feasibility-audit-2026-06-30.md`: deep live-executable audit for `HYPE-5M-PBTR-V6.2.1`; finds no explicit lookahead, stale crossed stop, or optimistic same-bar TP/SL ordering issue, but keeps the strategy at dry-run / tiny-notional audit status because live bracket maintenance and order-latency evidence are still required.
- `live-specs/hype-5m-pbtr-v6-2-1-live-spec.md`: complete implementation handoff spec for `HYPE-5M-PBTR-V6.2.1`, including leg parameters, feature formulas, signal suppression, one-position combo rules, bracket/timeout execution, persistence fields, restart recovery, and audit gates.
- `diagnostics/hype-5m-pbtr-v6-2-1-dynamic-atr-bracket-2026-06-30.md`: tests dynamic ATR TP/SL alternatives for `HYPE-5M-PBTR-V6.2.1`; confirms the current default is fixed entry-ATR bracket and finds no dynamic variant that improves return, PF, and drawdown together.
- `../cross-strategy-account/diagnostics/hype-pbtr-v6-2-1-mii-v1-3-shared-account-2026-07-02.md`: combines `HYPE-5M-PBTR-V6.2.1` with `HYPE-15M-MII-V1.3` on one HYPEUSDT sub-account with a global one-position constraint. The combo increases sample compounded return; realized closed-trade DD is `-30.28%`, 5m/15m close MTM DD is `-32.34%`, and worst high/low adverse mark is near `-55%`, so it does not promote either strategy.
...
- `artifacts/hype_5m_pbtr_v6-2-1_full_ablation_slices_2026-06-29.csv`
- `artifacts/hype_5m_pbtr_v6-2-1_full_ablation_sides_2026-06-29.csv`
- `artifacts/hype_5m_pbtr_v6-2-1_full_ablation_monthly_2026-06-29.csv`
- `artifacts/hype_5m_pbtr_v6-2-1_baseline_trades_2026-06-29.csv`
...
- `artifacts/hype_5m_pbtr_v6-2-1_live_feasibility_trades_2026-06-30.csv`
- `artifacts/hype_5m_pbtr_v6-2-1_feature_causality_2026-06-30.csv`
- `artifacts/hype_5m_pbtr_v6-2-1_dynamic_atr_bracket_2026-06-30.json`
- `artifacts/hype_5m_pbtr_v6-2-1_dynamic_atr_bracket_summary_2026-06-30.csv`
- `artifacts/hype_5m_pbtr_v6-2-1_dynamic_atr_bracket_trades_2026-06-30.csv`
