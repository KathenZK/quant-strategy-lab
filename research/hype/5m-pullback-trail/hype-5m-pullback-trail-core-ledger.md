...
| `HYPE-5M-PBTR-V6.2` | V6.1 long-only + short rank2：long `EMA21/55 TP2.5/SL7/tx36`，short `EMA34/144 TP1.5/SL2/tx48`，组合严格单仓。 | registered / not promoted / forward-test required | `210` | 见诊断 | `64.76%` | `0.96` | `-22.38%` | OOS PF `1.439` | 由 `combo_short_rank2` 固化；总收益 `+833.71%`、PF `1.771`，但 short OOS 只有 `5` 笔。只允许 1x 或极小 notional 验证，不是生产版本。 |
