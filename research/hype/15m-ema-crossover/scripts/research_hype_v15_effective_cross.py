...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v15_effective_cross.json")
CROSS_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v15_effective_cross_events.csv")
RULE_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v15_effective_cross_rule_stats.csv")
RANKING_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v15_effective_cross_ranking.csv")
REGIME_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v15_effective_cross_regimes.csv")
