...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v14_slow_trend_entry.json")
RANKING_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v14_slow_trend_entry_ranking.csv")
REGIME_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v14_slow_trend_entry_regimes.csv")
TRADE_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v14_slow_trend_entry_best_trades.csv")
