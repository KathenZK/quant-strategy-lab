...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_trend_state_search.json")
RANKING_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_trend_state_search_ranking.csv")
CONSTRAINT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_trend_state_search_constraints.csv")
TRADES_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_trend_state_search_top_trades.csv")
