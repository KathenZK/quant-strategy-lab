...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_state_machine_v12.json")
RANKING_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_state_machine_v12_ranking.csv")
TOP_TRADES_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_state_machine_v12_top_trades.csv")
