...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_ema_volume_exhaustion_v7.json")
RANKING_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_ema_volume_exhaustion_v7_ranking.csv")
TOP_TRADES_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_ema_volume_exhaustion_v7_top_trades.csv")
