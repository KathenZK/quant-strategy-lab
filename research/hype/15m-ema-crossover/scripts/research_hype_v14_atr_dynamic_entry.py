...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v14_atr_dynamic_entry.json")
RANKING_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v14_atr_dynamic_entry_ranking.csv")
MISS_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v14_atr_dynamic_entry_missed_regimes.csv")
FAILURE_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v14_atr_dynamic_entry_signal_failures.csv")
