...
CSV_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_main_result_backfill_v14.csv")
JSON_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_main_result_backfill_v14.json")
