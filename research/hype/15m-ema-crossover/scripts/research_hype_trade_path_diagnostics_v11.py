...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_trade_path_diagnostics_v11.json")
DETAIL_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_trade_path_diagnostics_v11_detail.csv")
SUMMARY_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_trade_path_diagnostics_v11_summary.csv")
CATEGORY_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_trade_path_diagnostics_v11_categories.csv")
