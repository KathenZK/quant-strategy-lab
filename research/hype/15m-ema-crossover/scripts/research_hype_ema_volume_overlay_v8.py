...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_ema_volume_overlay_v8.json")
RANKING_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_ema_volume_overlay_v8_ranking.csv")
TOP_TRADES_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_ema_volume_overlay_v8_top_trades.csv")
