...
REPORT_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_hybrid_ablation.json")
RANKING_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_hybrid_ablation_ranking.csv")
SENSITIVITY_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_hybrid_ablation_sensitivity.csv")
WINDOWS_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_hybrid_ablation_top_windows.csv")
ATTRIBUTION_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_hybrid_ablation_trade_attribution.csv")
DIAG_BASE_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_hybrid_ablation_base_diagnostics_summary.csv")
DIAG_BEST_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_hybrid_ablation_best_diagnostics_summary.csv")
DIAG_DETAIL_PATH = Path("research/hype/15m-ema-crossover/artifacts/hype_v17_hybrid_ablation_best_diagnostics_detail.csv")
