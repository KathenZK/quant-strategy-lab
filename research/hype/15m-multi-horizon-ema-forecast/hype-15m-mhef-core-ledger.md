...
- Live-readiness blockers：全区间毛收益与净收益均为负；连续调仓换手过高；未审计最小订单、数量步长、拒单、重启恢复与保护性风控。
...
当前无 registered version。基线结果见 [2026-07-14 回测](notes/hype-15m-mhef-baseline-backtest-2026-07-14.md)。
