...
- 当前状态：V3.3 直接迁移 `NO-GO`（未修复 trailing 解锁后 stop 可执行性）；bracket 搜索有一个 `paper-audit` 候选 `ema21_96_pb0.015_long_nocandle__ret32>=600__tp2_sl4_tx24`，OOS 样本仍太短，`not promoted / not live-ready`。
...
- V3.3 迁移诊断（NO-GO 证据）：`diagnostics/hype-15m-pullback-trail-v3-3-migration-2026-06-30.md`
