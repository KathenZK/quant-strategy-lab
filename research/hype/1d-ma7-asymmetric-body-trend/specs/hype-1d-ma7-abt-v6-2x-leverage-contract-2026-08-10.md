# HYPE-1D-MA7-ABT-V6 固定 2x 杠杆诊断合同
...
- 冻结主窗 `[0,432)`：`2025-05-31` 至 `2026-08-05 UTC` 共432个完整日；
...
1. exact V6 `1x` 与固定 `2x` 的全窗收益、折算年化、真实顺序 `1h` MDD、
...
1. V6 规格与 PEHC 原预注册合同原本要求 `1x` clean prospective PASS 前不运行杠杆。
   用户于 2026-08-10 明确要求查看 V6 的 `2x` 表现，本轮因此只作为一次
