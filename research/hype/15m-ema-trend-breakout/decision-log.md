...
- `HYPE-EMA-TB-V40`：V39 + V37 标准 early-long 小仓卫星观察候选。
...
- 2026-07-08（V40 登记 / V39 + V37 卫星叠加）：按用户指定，将 `V39+sat_v025` 登记为 `HYPE-EMA-TB-V40`，即 V39 主仓 + V37 标准 early-long 小仓卫星。V40 full `+12322.33% / -24.76% / Sharpe 4.91 / 149 笔`，所有分片优于纯 V39（`+9969.45% / -23.46% / 4.81`）与 V37 复现（`+10316.90% / -24.76% / 4.85`）；代价与 V37 同构：maxDD 加深约 1.3pp、组合胜率 79.44% -> 73.15%。标准分片开单量：1d 0、7d 3、1m 11、3m 49、6m 90、1y 145、full 149（full 拆分为主腿 107 / 卫星 42）。卫星量能维持 标准 0.25；用卫星补 V39 量能缺口（`sat_gap`）被否决（maxDD -25.98%，反向验证 V39 量能改动）。V40 登记为观察候选，未 live-ready；上线前需跨所迁移、walk-forward 和组合持仓审计。报告见 `notes/hype-ema-tb-v39-v37-satellite-2026-07-08.md`。
- 2026-07-08（V40 卫星有效性诊断）：卫星 standalone `+25.17% / -9.09% / Sharpe 1.57 / 42 笔 / 胜率 57.14%`，profit factor `1.87`；top 5 盈利只占总盈利 `26.87%`，不是少数极端单撑起。但稳定性一般：最近 1m `-0.12%`，14 个自然月里 7 正 5 负 2 无交易；2026-03 出现 5 笔全亏。对组合长期有正贡献（full 相比 V39 +2352.88pp 收益），但短期会拖累并放大回撤（1m maxDD `-20.11% -> -24.76%`）。42 笔中 14 笔与 V39 主仓重叠，需组合持仓与订单冲突审计。结论：卫星有效，但只适合作为 V40 小仓 overlay，不适合作为独立主策略。报告见 `notes/hype-ema-tb-v40-satellite-effectiveness-diagnostic-2026-07-08.md`。
