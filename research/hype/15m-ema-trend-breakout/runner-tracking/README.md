...
- 2026-08-17 共享 HYPE 15m 行情组再次 `group_halted`（EMA-TB NextOpen 缺 K 触发，同组 dry-run 一并停）。事件落档见 [hype-15m-group-halt-2026-08-17.md](hype-15m-group-halt-2026-08-17.md)。
