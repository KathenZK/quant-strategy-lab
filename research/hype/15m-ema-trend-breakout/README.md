...
- 当前状态：active 研究线。`HYPE-EMA-TB-V35` 为 `live`（独立 hype-trend live runner 运行，部署早于当前 handoff 约定，`runner-tracking/` 回流待补）；V36-V40 为 `registered / not promoted / not live-ready` 观察版本。
