...
- 当前状态：原始 `3-5` 笔/天形态 `NO-GO`；放宽频率后 V1-V1.3 已登记，均为 `paper-audit / not promoted / not live-ready`。
...
- 首次广搜（原始形态 NO-GO 证据）：`diagnostics/hype-5m-micro-scalp-search-2026-06-26.md`
