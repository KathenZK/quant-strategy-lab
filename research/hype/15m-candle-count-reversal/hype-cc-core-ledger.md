...
- Runner：quant-runner `kind = "hype_candle_count"`；实际实例启用与模式只以 quant-runner 为准。
...
- V0-V34 是历史演化证据；当前研究身份只由版本表、V35 规格与 handoff 决定。
