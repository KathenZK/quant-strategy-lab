...
- 当前状态：家族整体 `not promoted / not live-ready`；`HYPE-15M-MII-V1.3`（V1.2 的固定 `2.5x` sizing 版）为 `live spec / not live-ready`，已在 quant-runner 实现并 dry-run。
...
- 主账（V1/V1base/V1.1/V1.2/V1.3 版本表与证据索引）：`hype-15m-mii-core-ledger.md`
...
- V1.3 近期诊断（信号干旱 / ATR 口径 / min_atr 网格 / recent trade frequency / RVOL 阈值对比）：`research-notes/` 下 `hype-15m-mii-v1-3-*.md` 系列
