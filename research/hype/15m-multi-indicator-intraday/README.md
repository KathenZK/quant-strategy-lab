...
- 当前状态：家族整体 `NO-GO`；`HYPE-15M-MII-V1.3`（V1.2 的固定 `2.5x` sizing 版）为 `runner implementation target / not live-ready`，已在 quant-runner 实现并 dry-run。
...
- V1.3 近期诊断（信号干旱 / ATR 口径 / min_atr 网格 / recent trade frequency / `rvol0.9` 频率对比）：`research-notes/` 下 `hype-15m-mii-v1-3-*.md` 系列
