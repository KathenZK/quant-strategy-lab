...
- `Binance-15M-Asset-Specific-Six-Strategy-Selector`（`BIN-15M-AS6S`）：[15m-asset-specific-six-strategy-selector/](15m-asset-specific-six-strategy-selector/README.md)。V1 为六币资产专属 `15m/1h` 九腿、全局单仓、不抢占路线；强突破抢占保留为对照 observation；已冻结等待未来三个月最终 OOS，`registered / not promoted / not live-ready`。主账：[binance-15m-as6s-core-ledger.md](15m-asset-specific-six-strategy-selector/binance-15m-as6s-core-ledger.md)。
