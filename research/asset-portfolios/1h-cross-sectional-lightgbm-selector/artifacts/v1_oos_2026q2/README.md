...
本目录原存放 V1 OOS 模型、预测、逐腿、组合、基线、压力分片及 `REVOCATION.json` 等事故证据。2026-08-04 磁盘清理已删除全部非 Markdown 产物；绩效结论的撤销状态不变，不得再用于选参、宣传、复现有效策略或 promotion。
...
长期结论见 [公式纠错审计](../../diagnostics/binance-1h-cslgbm-v1-oos-2026-07-17.md) 与 [decision-log](../../decision-log.md)。
