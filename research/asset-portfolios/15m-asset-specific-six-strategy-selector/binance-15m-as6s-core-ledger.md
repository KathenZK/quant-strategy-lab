...
| `BIN-15M-AS6S-V5-JOINT-NP`（V5 joint-state observation） | `retired 2026-08-04 / not registered / not promoted` | 15 条资产专属腿、真实成交驱动 cooldown、nonpreemptive 联合单仓，账户缩放 `0.40` | full：`5.8156x annual / +3280.13% / -12.86% DD / 85.17% / 553` | [Runner 对拍](runner-tracking/binance-as6s-v5-joint-runner-2026-07-15.md)；[退役记录](runner-tracking/binance-as6s-v5-retire-engine-inhouse-2026-08-04.md) | Runner 侧 V5 已整体退役：manifest 条目、TOML 实例与策略目录全部移除，引擎代码作为 V6 内部模块保留；不构成 V5 注册或 promotion |
