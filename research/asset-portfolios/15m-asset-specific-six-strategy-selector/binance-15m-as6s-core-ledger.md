...
| `BIN-15M-AS6S-V5-JOINT-NP`（V5 joint-state observation） | `archived` | 15 条资产专属腿、真实成交驱动 cooldown、nonpreemptive 联合单仓，账户缩放 `0.40` | full：`5.8156x annual / +3280.13% / -12.86% DD / 85.17% / 553` | [Runner 对拍](runner-tracking/binance-as6s-v5-joint-runner-2026-07-15.md) | 未登记 observation，仅保留历史实现与对拍叙事 |
...
- V5 观察与历史 Runner 对拍：[diagnostics/binance-as6s-v5-joint-state-observation-2026-07-14.md](diagnostics/binance-as6s-v5-joint-state-observation-2026-07-14.md)、[runner-tracking/binance-as6s-v5-joint-runner-2026-07-15.md](runner-tracking/binance-as6s-v5-joint-runner-2026-07-15.md)
