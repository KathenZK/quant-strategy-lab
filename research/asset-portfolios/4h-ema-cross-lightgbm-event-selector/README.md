...
- 尚未注册版本；身份与裁决见 [binance-4h-emax-lgbm-core-ledger.md](binance-4h-emax-lgbm-core-ledger.md)。局部+趋势精简选择器事件级越过成本墙（Gate B 过，2026-07-29）后正式立项 V3 组合级回测：回撤压回 −19.4%（G1 过）且打分层增值成立（G4 过），但盈利 83% 集中 2022 熊市、四年仅两年为正（G2 未过），**V3 不登记**。死因与重启条件见 [V3 组合级判决](diagnostics/bin-4h-emax-v3-portfolio-2026-07-30.md)。

## 入口

- 主账：[binance-4h-emax-lgbm-core-ledger.md](binance-4h-emax-lgbm-core-ledger.md)
