"""Port of the 15m local+trend LightGBM selector to 1h events.

Implements specs/bin-1h-emax-local-trend-selector-contract-2026-07-29.md.
Reuses the frozen events_dev_1h.parquet and the 15m feature modules
(bar-count windows unchanged; multi-day trend windows rescaled to 1h bars).
