...
截至本报告生成时：应有节点 `2`，实际节点 `2`，其中 `FROZEN_ON_TIME=1`、`MISSED=1`、缺失 `0`；链尾 SHA256 为 `f3739f9545e0a65296803507d8959e866c62d5eb16a8e367d34f1a496b65827d`。该快照只证明运行完整性，不证明策略盈利。
