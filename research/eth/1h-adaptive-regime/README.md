...
- 当前状态：V1、V2、V2.1、V3 已登记；reused holdout 仍为负；`NO-GO / not promoted / not live-ready`。
...
- 版本规格：`canonical-specs/`（V1 baseline、V2 clean tuned、V2.1 high-win tuned、V3 clean tuned）
