...
- 状态：`registered diagnostic tuned observation / NO-GO / not promoted / not live-ready`。
...
- V2.1 参数说明：`eth-1h-ar-v2-1-high-win-tuned-spec-2026-07-06.md`。V2.1 不修改本 V2 canonical spec，不构成 candidate、paper-live、dry-run、handoff 或 live。
