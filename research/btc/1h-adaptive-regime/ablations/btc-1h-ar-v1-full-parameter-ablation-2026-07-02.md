...
分类结果：`{'active_tunable': 27, 'baseline_fixed_remove': 35, 'contract_fixed': 12, 'neutral_fixed_remove': 4}`。其中 baseline fixed 与 neutral fixed 字段从后续 clean tuning surface 移除；contract fixed 字段保留为实现常量，不进入搜索。
...
| `keltner_break` | `ema_fast` | `55` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `keltner_break` | `ema_htf` | `55` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `keltner_break` | `ema_slow` | `144` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
...
| `keltner_break` | `macd_fast` | `8` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `keltner_break` | `macd_signal` | `5` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `keltner_break` | `macd_slow` | `21` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
...
| `keltner_break` | `max_leverage` | `2.0` | `baseline_fixed_remove` | `3` | `3` | `3` | `0` |
...
| `keltner_break` | `pullback_atr` | `0.75` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `keltner_break` | `require_body_dir` | `False` | `baseline_fixed_remove` | `1` | `1` | `1` | `0` |
| `keltner_break` | `require_macd_turn` | `False` | `baseline_fixed_remove` | `1` | `0` | `0` | `0` |
| `keltner_break` | `risk_fraction` | `0.015` | `baseline_fixed_remove` | `3` | `3` | `3` | `0` |
| `keltner_break` | `roc_threshold_bps` | `300.0` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
...
| `keltner_break` | `threshold_high` | `85.0` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `keltner_break` | `threshold_low` | `20.0` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `keltner_break` | `tp_atr` | `1.5` | `active_tunable` | `4` | `0` | `0` | `0` |
| `keltner_break` | `trail_activation_atr` | `3.0` | `baseline_fixed_remove` | `3` | `3` | `3` | `0` |
| `keltner_break` | `trail_atr` | `1.5` | `baseline_fixed_remove` | `3` | `3` | `3` | `0` |
| `cci_reversal` | `band_k` | `1.5` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `cooldown_bars` | `24` | `active_tunable` | `4` | `0` | `0` | `1` |
| `cci_reversal` | `ema_fast` | `89` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `ema_htf` | `144` | `active_tunable` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `ema_slow` | `233` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
...
| `cci_reversal` | `htf_mode` | `none` | `baseline_fixed_remove` | `3` | `0` | `0` | `0` |
| `cci_reversal` | `indicator_window` | `20` | `active_tunable` | `3` | `0` | `0` | `0` |
| `cci_reversal` | `macd_fast` | `21` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `macd_signal` | `9` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `macd_slow` | `55` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `max_adx` | `36.0` | `active_tunable` | `3` | `0` | `0` | `0` |
| `cci_reversal` | `max_aligned_funding_bps` | `10000.0` | `baseline_fixed_remove` | `4` | `2` | `2` | `0` |
...
| `cci_reversal` | `max_leverage` | `2.5` | `baseline_fixed_remove` | `3` | `3` | `3` | `0` |
| `cci_reversal` | `min_adx` | `0.0` | `neutral_fixed_remove` | `3` | `1` | `1` | `0` |
| `cci_reversal` | `min_atr_bps` | `50.0` | `active_tunable` | `3` | `0` | `0` | `0` |
| `cci_reversal` | `min_dir_roc_bps` | `-10000.0` | `baseline_fixed_remove` | `3` | `0` | `0` | `0` |
| `cci_reversal` | `min_rvol` | `1.5` | `active_tunable` | `4` | `0` | `0` | `0` |
| `cci_reversal` | `name` | `BTC_1H_AR_V1_CCI` | `contract_fixed` | `1` | `1` | `1` | `0` |
| `cci_reversal` | `pullback_atr` | `-0.25` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `require_body_dir` | `False` | `baseline_fixed_remove` | `1` | `0` | `0` | `0` |
| `cci_reversal` | `require_macd_turn` | `False` | `baseline_fixed_remove` | `1` | `0` | `0` | `0` |
| `cci_reversal` | `risk_fraction` | `0.01` | `baseline_fixed_remove` | `3` | `3` | `3` | `0` |
| `cci_reversal` | `roc_threshold_bps` | `300.0` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `roc_window` | `48` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
...
| `cci_reversal` | `threshold_low` | `40.0` | `baseline_fixed_remove` | `2` | `2` | `2` | `0` |
| `cci_reversal` | `tp_atr` | `4.0` | `active_tunable` | `4` | `0` | `0` | `0` |
| `cci_reversal` | `trail_activation_atr` | `0.75` | `baseline_fixed_remove` | `3` | `3` | `3` | `0` |
| `cci_reversal` | `trail_atr` | `1.25` | `baseline_fixed_remove` | `3` | `3` | `3` | `0` |
