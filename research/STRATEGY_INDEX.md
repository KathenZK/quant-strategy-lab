...
Read `research/hype/AI_CONTEXT.md` before reading any HYPE strategy document.
...
- `HYPE-5M-PBTR`: `hype/families/5m-pullback-trail/hype-5m-pullback-trail-core-ledger.md`
  ...
  - V6 paper candidate and full ablation: `hype/families/5m-pullback-trail/ablations/hype-5m-pbtr-v6-full-parameter-ablation-2026-06-25.md`.
- `HYPE-CC`: `hype/families/candle-count-reversal/hype-cc-15m-milestone-comparison.md`
- Repo rule mirrors:
  - `research/hype/families/ema-crossover/v15-v16-promoted-strategy-specs.md`
  - `research/hype/families/ema-crossover/v17-hybrid-ablation.md`
...
- `MU-HYPE-XFER`: `research/mu/README.md` and `research/mu/mu-hype-xfer-session-aware-ledger.md`
