...
- `BNB-1H-Adaptive-Regime`（`BNB-1H-AR`）：Binance USD-M Futures `BNBUSDT` perpetual `1h` 多指标自适应 regime 广泛搜索；`BNB-1H-Adaptive-Regime-V1` 已登记为 `ema_pullback+wick_reject` diagnostic observation；`BNB-1H-Adaptive-Regime-V2` 已登记为 V1 clean-equivalent 版本；`BNB-1H-Adaptive-Regime-V3` 已登记为 V2 消融引导微调版本，实际最大杠杆 `2.5x`，full `2.94x / -18.24% / 88.33%`，reused OOS `1.22x / -15.53% / 81.25%`；locked OOS 属二次读取，当前仍为 `NO-GO / not promoted / not live-ready`。
