...
| `BNB-1H-Adaptive-Regime-V3` | tuned diagnostic observation；not promoted | V2 消融引导微调登记版本；实际最大暴露 `2.5x`；prefit `3.37x / 89.42% / -18.24%`，reused locked OOS `1.22x / 81.25% / -15.53%`，full `2.94x / 88.33% / -18.24%`；2026-07-13 prefit-only 边界净化复核：K+1 `3.05x / -18.24% / 89.11%`，K+2 `1.36x / -31.04% / 79.21%`，8bps `2.64x / -18.42% / 87.25%`；exit/filter 分阶段与受限合装 `0` 个通过联合门槛，未产生 V4 | `specs/bnb-1h-ar-v3-parameter-spec-2026-07-07.md`；`notes/bnb-1h-ar-v2-micro-tune-2026-07-07.md`；`notes/bnb-1h-ar-v3-prefit-walkforward-optimization-2026-07-13.md`；`scripts/bnb_1h_ar_v3.py` | OOS 属于 reused observation；K+2 回撤为当前执行稳健性 blocker；未经过 fresh forward，不可 candidate / paper-live / dry-run / handoff / live |
