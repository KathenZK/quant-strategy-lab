...
| [multi-horizon-ema-forecast/](multi-horizon-ema-forecast/README.md) | `v1` | 多参数 EMA 波动率归一化 forecast、连续仓位、成本与 funding 回测 | HYPE `15m` / `1h` / `1d` multi-horizon EMA forecast 家族；`BTC-1D-Classic-CTA-Trend` |
