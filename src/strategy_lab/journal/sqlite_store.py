...
if TYPE_CHECKING:
    from strategy_lab.journal.registry import BacktestJournalEntry
...
class RunSqliteStore:
    ...
    def _run_record(self, entry: BacktestJournalEntry, manifest_payload: dict | None = None) -> dict[str, object]:
    ...
    def upsert_run(self, entry: BacktestJournalEntry, *, manifest_payload: dict | None = None) -> Path:
        self.ensure_schema()
