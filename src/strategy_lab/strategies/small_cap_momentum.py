...
class SmallCapMomentumBreakoutConfig:
    ...
    The universe is expected to be pre-filtered in workflow config by market cap
    or by a practical proxy such as Binance small-volume symbols. Execution risk
