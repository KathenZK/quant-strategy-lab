...
from strategy_lab.batches.config import load_workflow_batch_config
from strategy_lab.batches.models import BatchRunMode, WorkflowBatchConfig

if TYPE_CHECKING:
    from strategy_lab.comparison.models import StrategyComparisonArtifacts
    from strategy_lab.experiments.models import ExperimentArtifacts
...
def run_workflow_batch(
    ...
    *,
    ...
    if mode == BatchRunMode.EXPERIMENT:
        from strategy_lab.experiments.models import ExperimentConfig
    ...
    if mode == BatchRunMode.COMPARISON:
        ...
        from strategy_lab.comparison.runner import StrategyComparisonRunner
